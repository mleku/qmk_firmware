...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_ortho_5x15(KC_S, KC_HASH, KC_QUOT, KC_X, KC_GRV, KC_O, KC_TRNS, KC_TRNS, KC_TRNS, KC_RBRC, KC_NO, KC_M, KC_NO, KC_MINS, KC_EQL, KC_NO, KC_AT, KC_QUES, KC_SLSH, KC_G, KC_Q, KC_TRNS, KC_TRNS, KC_TRNS, KC_A, KC_U, KC_W, KC_H, KC_K, KC_BSLS, KC_TRNS, KC_F, KC_J, KC_T, KC_E, KC_B, KC_TRNS, KC_TRNS, KC_TRNS, KC_L, KC_LBRC, KC_N, KC_Y, KC_C, LSFT(KC_BSLS), MO(4), KC_CIRC, KC_Z, KC_SCLN, KC_R, KC_DOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_COMM, KC_V, KC_I, KC_D, KC_P, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LGUI(KC_SPC), KC_TRNS, KC_LPRN, KC_RPRN),
